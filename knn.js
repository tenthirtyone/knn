...
NodeList.prototype.determineUnknown = function() {
	...
	for (var i in this.nodes) {
		if (! this.nodes[i].type) {
			...
			return Object.keys(this.nodes[i].guessType(this.k))[0];
		}
	}
};
...
/*
Dead Space
	{rooms: 6, area: 600, type: 'null'},
	{rooms: 10, area: 300, type: 'null'},
	{rooms: 9, area: 500, type: 'null'},
	{rooms: 7, area: 150, type: 'null'},
	{rooms: 7, area: 350, type: 'null'},
	{rooms: 8, area: 450, type: 'null'},
	{rooms: 9, area: 550, type: 'null'},

	{rooms: 3, area: 1900, type: 'null'},
	{rooms: 1, area: 1300, type: 'null'},
	{rooms: 2, area: 1500, type: 'null'},
	{rooms: 4, area: 1580, type: 'null'},
	{rooms: 3, area: 1350, type: 'null'},
	{rooms: 2, area: 1450, type: 'null'},
	{rooms: 1, area: 1550, type: 'null'},
	*/
];
var run = function() {
  var k = 9;
	nodes = new NodeList(k);
	for (var i in data) {
	...
	var type = nodes.determineUnknown();
	nodes.draw("canvas");
	//data.push({rooms: random_rooms, area: random_area, type: type});
};
